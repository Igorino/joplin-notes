...
**d)** Esparcidade se refere a quanto o modelo depende de poucos elementos para fazer uma previsão. A LSVM tende a ser mais esparsa, pois a predição usa apenas um vetor de pesos. Já a SVM kernelizada depende de vários vetores de suporte, o que reduz a esparsidade, e faz com que a LSVM seja a mais rápida e eficiente.