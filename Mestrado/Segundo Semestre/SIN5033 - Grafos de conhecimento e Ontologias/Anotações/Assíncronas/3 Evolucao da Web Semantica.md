...
# A virada central
A web que hoje nós conhecemos é uma **web de documentos**: HTML é usado para fazer a sua *estrutura visual*, HTTP é usado para *comunicação* e URI é usado para fazer o *endereçamento*. Os 