...
A combinação da função softmax com a entropia cruzada simplifica a expressão do gradiente, o que resulta em um termo de erro na camada de saída dado por $P - Y$. A partir disso, o gradiente dos parâmetros do MLP é obtido por backpropagation usando a regra da cadeia mostrada nos slides.