...
Como que a máquina raciocina sobre isso? Com o **Algoritmo de Tableaux** (inventado por Beth em 1955, simplificado por Smullyan em 1968), que é a mesma ideia da prova por refutação da aula 05: pra provar alguma coisa, **assume-se a negação e mostra que ela leva a uma contradição**, expandindo o ABox com regras até bater num impossível.
