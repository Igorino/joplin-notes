...
| **Andreasen & Esterle (2025, arXiv, PREPRINT)** | Mede latência e VRAM por NPC usando SLMs (DistilGPT-2, TinyLlama-1.1B, Mistral-7B) em hardware de consumo. Mostra latência alta mesmo com quantização.
