...
| **Andreasen & Esterle (2025, arXiv, PREPRINT)** | Mede latência e VRAM por NPC usando Small Language Models (SLMs), como DistilGPT-2, TinyLlama-1.1B, Mistral-7B, em "hardware de consumo". Mostra latência alta mesmo com divisão. | Evidência recente complementar. , mas sem revisão por pares; citar com ressalva, nunca como base. Escopo: diálogo. |
